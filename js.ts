...
function generateRandomPoints(amnt:number){
    let pts:number[][] = [];
...
function big_triangle(points:number[][]) {
...
function circumcircle_of_triangle(points:number[][], v1:number, v2:number, v3:number) {
